...
import { SubscriberListPage as ShowCaseList } from 'pages/subscribers';
...
function DashboardPage() {
  ...
  const appStat = useSWR<PaginatedInterface<AppInterface>>(
    () => `/apps`,
    () => getApps({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Apps',
      result: appStat?.data?.totalCount,
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`subscribers`} passHref legacyBehavior>
                  <Button
